					...
					<div className="row">
						<div className="col-md-3 col-sm-12 footer-1">
							<div className="mt-20 mb-20">
								...
								<div className="box-info-contact mt-20">
									<p className="text-md neutral-400 icon-address">Hanau & Frankfurt am Main
										Hessen, Germany</p>
									<p className="text-md neutral-400 icon-worktime">Hours: 8:00 - 17:00, Mon - Sat</p>
									<p className="text-md neutral-400 icon-email">support@emoviral.com</p>
								</div>
								<div className="box-need-help">
									<p className="need-help text-md-medium mb-5">Need help? Call us</p>
									<br /><Link className="heading-6 phone-support" href="/tel:+49 6438 4039867">+49 6438 4039867</Link>
								</div>
							</div>
						</div>
					...
					<div className="footer-bottom mt-50">
						<div className="row align-items-center justify-content-center">
							<div className="col-md-6 text-md-start text-center mb-20">
								<p className="text-sm color-white">© {new Date().getFullYear()} emoviral Inc. All rights reserved.</p>
							</div>
