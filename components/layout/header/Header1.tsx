					...
					<div className="container-fluid">
						<div className="text-header-info">
							<Link className="phone-head text-white" href="#">
								...
								<span className="d-none d-lg-inline-block">+49 6438 4039867</span>
							</Link>
							<Link className="email-head text-white" href="#">
								...
								<span className="d-none d-lg-inline-block">hi@emoviral.com</span>
							</Link>
						</div>
						<div className="text-header">
							...
							<Link className="btn btn-brand-2 btn-small text-dark px-3 py-2 text-xs-medium " href="https://www.emoviral.com/">
								Zurück zur EmoViral Hauptseite
						...
						<div className="header-left">
							...
							<div className="header-right">
								...
								<div className="burger-icon-2 burger-icon-white" onClick={handleOffcanvas}>
									<img src="/assets/imgs/template/icons/menu.svg" alt="emoviral" />
								</div>
